-- ============================================================
-- Panela da Roça — Fundo de Caixa (Fechamento do Dia)
-- Colunas de fundo de caixa + RPC fechar_dia atualizada
-- Idempotente: pode rodar quantas vezes quiser.
-- ============================================================

ALTER TABLE fechamento_dia
  ADD COLUMN IF NOT EXISTS fundo_caixa NUMERIC DEFAULT 0,
  ADD COLUMN IF NOT EXISTS caixa_contado NUMERIC DEFAULT 0,
  ADD COLUMN IF NOT EXISTS diferenca_caixa NUMERIC DEFAULT 0;

-- ────────────────────────────────────────────────────────────
-- fechar_dia (atômico + fundo de caixa)
